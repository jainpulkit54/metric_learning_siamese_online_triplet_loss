...
os.makedirs('outputs_FMNIST', exist_ok = True)
os.makedirs('outputs_MNIST', exist_ok = True)
...
checkpoints_path = 'checkpoints_MNIST/model_epoch_10.pth'
...
def plot_embeddings(embeddings, targets):
	...
	plt.savefig('outputs_MNIST/embeddings_trainset.png')
	plt.show()
